#language: pt
Funcionalidade: Tela de relatório de Titulos Vencidos
    Eu como analista de testes
    Quero acessar a aplicação cineflix da recordTv
    Para testar a tela de relatório de titulos vencidos do sistema

    Contexto: 
    Dado que eu acesse a aplicacao cineflix
    E realizar o login na aplicacao com sucesso
    Quando clicar no menu "Relatório"
    E clicar na opção "Títulos Vencidos"

    @automacao
    Cenário: Validar elementos da tela de relatório de Títulos Vencidos
        # CORRIGIR BUG
        # titulo da tela e o nome do filtro
        Então o sistema deve exibir o titulo "Título Vencidos" 
        E o sistema deve exibir a tela de relatório "Títulos Vencidos" contendo os seguintes filtros:
    ...
    Cenário: Validar funcionamento da caixa com total de itens encontrados
        # Quando eu realizar o filtro na tela de relatório de Títulos Vencidos

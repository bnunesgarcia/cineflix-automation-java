#language: pt
Funcionalidade: Tela de relatório de Titulos que ficarão Disponíveis
    Eu como analista de testes
    Quero acessar a aplicação cineflix da recordTv
    Para testar a tela de relatório de titulos que ficarão disponíveis do sistema

    Contexto: 
    Dado que eu acesse a aplicacao cineflix
    E realizar o login na aplicacao com sucesso
    Quando clicar no menu "Relatório"
    E clicar na opção "Títulos que ficarão Disponíveis"

    @automacao
    Cenário: Validar elementos da tela de relatório de Títulos que ficarão Disponíveis
        Então o sistema deve exibir o titulo "Título que ficarão Disponível"
        E o sistema deve exibir a tela de relatório "Títulos que ficarão Disponíveis" contendo os seguintes filtros:
        | Período |
    ...
    Cenário: Validar funcionamento da caixa com total de itens encontrados
        # Quando eu realizar o filtro na tela de relatório de Títulos que ficarão Disponíveis
